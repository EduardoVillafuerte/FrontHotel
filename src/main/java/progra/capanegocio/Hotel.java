...
import static progra.capanegocio.Articulo.LIMITEBAJO;
import static progra.capanegocio.Articulo.LIMITEMEDIO;
import static progra.capanegocio.Articulo.LIMITEALTO;
...
//    }
    ...
    public String agregarReserva(int numReserva, Fecha fechaReserva, Fecha fechaInicio, Fecha fechaFin, Habitacion habitacion){
        ...
        reservas.add(new Reserva(habitacion,fechaReserva,fechaInicio,fechaFin, numReserva,diasTotal));
    ...
    public String agregarFactura(Cliente cliente, Reserva reserva, MetodoPago metodoPago){
        ...
        cliente.agregarFactura(new Factura((813+facturas.size()),cliente,new Fecha(dia,mes,anio),montTotal,metodoPago));
        facturas.add(new Factura((813+facturas.size()),cliente,new Fecha(dia,mes,anio),montTotal,metodoPago));
        return "se registro la reserva";
    }
}
